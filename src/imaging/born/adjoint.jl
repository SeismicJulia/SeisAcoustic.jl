...
approximation
"""
function sourceside_reconstruct_backward(path_bnd::Tp, path_wfd::Tp,
    ...
    for it = params.nt-1 : -1 : 1
        ...
        # remove dt * src[it+1]
        subtract_source!(wfd2, srcs, it+1)
...
"""
function born_approximation_adjoint(rec::Recordings, path_bnd::Tp, path_wfd::Tp,
                           src::Ts, params::TdParams) where {Tp<:String, Ts<:Union{Source,Vector{Source}}}
